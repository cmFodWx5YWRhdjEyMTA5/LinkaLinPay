...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_BAR_COLOR = Color.parseColor("#FF6600");

    private static final int DEFAULT_TEXT_COLOR = Color.WHITE;

    private static final int DEFAULT_TICK_COLOR = Color.parseColor("#FF6600");

    // Corresponds to material indigo 500.

    // bOLL NO COLOR
    private static final int DEFAULT_PIN_COLOR = Color.parseColor("#FF6600");
    ...
    // Sadi no color
    private static final int DEFAULT_CONNECTING_LINE_COLOR = Color.parseColor("#FF6600");
